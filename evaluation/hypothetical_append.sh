...
do    
    ...
    numactl --cpubind=$NUMADOMAIN --membind=$NUMADOMAIN ./"$EXE_PATH" >> "$RESULT_FOLDER"append_random_off.txt
...
do    
    ...
    numactl --cpubind=$NUMADOMAIN --membind=$NUMADOMAIN ./"$EXE_PATH" >> "$RESULT_FOLDER"append_random_on.txt
...
do    
    ...
    numactl --cpubind=$NUMADOMAIN --membind=$NUMADOMAIN ./"$EXE_PATH" >> "$RESULT_FOLDER"append_worst_on.txt
